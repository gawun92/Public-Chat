...
git clone https://github.com/rothfels/cyan.git $SLUG
cd $SLUG
rm -rf .git

sed -i.bak "s/cyan/$SLUG/g" **/*.tf
sed -i.bak "s/cyan/$SLUG/g" **/*.ts
sed -i.bak "s/cyan/$SLUG/g" **/*.yml
sed -i.bak "s/cyan/$SLUG/g" **/*.sh
sed -i.bak "s/cyan/$SLUG/g" **/*.json
rm -rf **/*.bak
