...
# Lambda URIs are "{+lambda}/{+function}" e.g. "cyan/ping".
# We also support path matching at the root e.g. "cyan" but these require definining separate "_root" terraform resources.
