...
usage="Usage: deploy-ecs.sh [cyan-app-web|cyan-app-background] [sha]"
...
new_image="101624687637.dkr.ecr.us-west-2.amazonaws.com/cyan:$2"
...
aws ecs update-service --cluster cyan \
  --no-cli-pager \
  --region "$ecs_region" \
